...
const wordsDescription = {
    ...
    "Rakendustarkvara": "Rakendustarkvara paigutub kihilise mudeli järgi „kõrgemale\" kihile - „eemale\" riistvarast ja lähemale arvutiga suhtlevale kasutajale. Rakendustarkvara ülesandeks on kasutaja soovide täitmine, \"kasutaja toetamine\" tema eesmärkide saavutamisel. Rakendustarkvara toetub süsteemitarkvarale. Rakendustarkvara võib olla avalikustatud eraldiseisvalt, kuid võib kaasa tulla ka operatsioonisüsteemiga. Igal juhul on kõige olulisem tema suunatus kasutaja abistamisele.",
    "Entroopia": "Entroopia (müra) on kommunikatsiooniteoorias seotud välisfaktoritega, mis moonutavad teadet, rikuvad selle terviklikust ja saaja poolt vastuvõtmise võimalikkust. Igat müraga kanalit iseloomustab selle info edastamise piirkiirus (Shannoni piirväärtus). Edastamise kiirus, mis on piirkiirusest suurem, tekitab vigu. Samas võib kiirus läheneda piirväärtusele altpoolt ükskõik kui lähedale ning vastava kodeeringuga on võimalik saavutada väga väike vea tõenäosus ka suvalise mürasisaldusega kanalis."
}
